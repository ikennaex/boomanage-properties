        ...
        <div className="container-content">
          <div className="lg:px-10 pt-14 container mx-auto px-7 h-fit lg:p-28 p-8 gap-4 flex flex-col lg:flex-row lg:justify-between items-center">
            <div className="flex flex-col items-center lg:items-start text-center lg:text-left">
              <p className="text-white font-bold">Boomanage Properties</p>
              <h1 className="lg:text-3xl lg:w-3/4 leading-tight font-black header-text text-3xl text-white pb-6 slide-in-bottom">
              ...
              <div className="pt-9 flex flex-row items-center gap-6 slide-in-left2">
                <a target="_blank" rel="noopener noreferrer" href="https://wa.me/2348135217518">
